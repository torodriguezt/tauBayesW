...
bayesQR_weighted_EM_cpp <- function(y, x, w, u, gamma_u, tau, mu0, sigma0, a0, b0, eps = 1e-6, max_iter = 1000L, verbose = FALSE) {
    .Call(`_tauBayesW_bayesQR_weighted_EM_cpp`, y, x, w, u, gamma_u, tau, mu0, sigma0, a0, b0, eps, max_iter, verbose)
}
