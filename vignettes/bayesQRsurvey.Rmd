...
In addition, it is possible to explicitly supply the orthogonal basis to mo.bqr.svy through the gamma_U (their orthogonal complements), instead of relying on the function to generate them internally.
